...
export declare class ScheduleGroupBy {
    ...
    date: Date;
    groupId: number;
    _count: ScheduleCountAggregate | null;
    _avg: ScheduleAvgAggregate | null;
    _sum: ScheduleSumAggregate | null;
    _min: ScheduleMinAggregate | null;
    _max: ScheduleMaxAggregate | null;
}
